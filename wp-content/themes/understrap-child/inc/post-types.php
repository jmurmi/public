...
// add_action( 'init', 'moore_settings', 1000 );
function moore_settings() {  
...
function custom_post_type_slide() {
	...
	$labels = array(
		'name'                  => _x( 'Slides', 'Post Type General Name', 'moore' ),
		'singular_name'         => _x( 'Slide', 'Post Type Singular Name', 'moore' ),
		'menu_name'             => __( 'Slides', 'moore-admin' ),
		'name_admin_bar'        => __( 'Slides', 'moore-admin' ),
		'add_new'               => __( 'Añadir nueva Slide', 'moore-admin' ),
		'new_item'              => __( 'Nueva Slide', 'moore-admin' ),
		'edit_item'             => __( 'Editar Slide', 'moore-admin' ),
		'update_item'           => __( 'Actualizar Slide', 'moore-admin' ),
		'view_item'             => __( 'Ver Slide', 'moore-admin' ),
		'view_items'            => __( 'Ver Slide', 'moore-admin' ),
	);
	$args = array(
		'label'                 => __( 'Slides', 'moore' ),
		'labels'                => $labels,
...
function custom_post_type_faq() {
	...
	$labels = array(
		'name'                  => _x( 'Preguntas frecuentes', 'Post Type General Name', 'moore' ),
		'singular_name'         => _x( 'Pregunta frecuente', 'Post Type Singular Name', 'moore' ),
		'menu_name'             => __( 'FAQs', 'moore-admin' ),
		'name_admin_bar'        => __( 'FAQs', 'moore-admin' ),
		'add_new'               => __( 'Añadir nueva FAQ', 'moore-admin' ),
		'new_item'              => __( 'Nueva FAQ', 'moore-admin' ),
		'edit_item'             => __( 'Editar FAQ', 'moore-admin' ),
		'update_item'           => __( 'Actualizar FAQ', 'moore-admin' ),
		'view_item'             => __( 'Ver FAQ', 'moore-admin' ),
		'view_items'            => __( 'Ver FAQ', 'moore-admin' ),
	);
	$args = array(
		'label'                 => __( 'Preguntas frecuentes', 'moore' ),
		'labels'                => $labels,
...
function custom_post_type_team() {
	...
	$labels = array(
		'name'                  => _x( 'Team members', 'Post Type General Name', 'moore' ),
		'singular_name'         => _x( 'Team member', 'Post Type Singular Name', 'moore' ),
		'menu_name'             => __( 'Miembro del equipo', 'moore-admin' ),
		'name_admin_bar'        => __( 'Miembros del equipo', 'moore-admin' ),
		'add_new'               => __( 'Añadir nuevo Miembro del equipo', 'moore-admin' ),
		'new_item'              => __( 'Nuevo Miembro del equipo', 'moore-admin' ),
		'edit_item'             => __( 'Editar Miembro del equipo', 'moore-admin' ),
		'update_item'           => __( 'Actualizar Miembro del equipo', 'moore-admin' ),
		'view_item'             => __( 'Ver Miembro del equipo', 'moore-admin' ),
		'view_items'            => __( 'Ver Miembro del equipo', 'moore-admin' ),
		'featured_image'		=> __( 'Foto', 'moore-admin' ),
		'set_featured_image'	=> __( 'Establecer Foto', 'moore-admin' ),
		'remove_featured_image'	=> __( 'Quitar Foto', 'moore-admin' ),
		'use_featured_image'	=> __( 'Usar como Foto', 'moore-admin' ),
	);
	$args = array(
		'label'                 => __( 'Team members', 'moore' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'page-attributes', 'post-formats' ),
		'hierarchical'          => false,
		'public'                => true,
...
function custom_post_type_testimonio() {
	...
	$labels = array(
		'name'                  => _x( 'Testimonios', 'Post Type General Name', 'moore' ),
		'singular_name'         => _x( 'Testimonio', 'Post Type Singular Name', 'moore' ),
		'menu_name'             => __( 'Testimonios', 'moore-admin' ),
		'name_admin_bar'        => __( 'Testimonios', 'moore-admin' ),
		'add_new'               => __( 'Añadir nuevo Testimonio', 'moore-admin' ),
		'new_item'              => __( 'Nuevo Testimonio', 'moore-admin' ),
		'edit_item'             => __( 'Editar Testimonio', 'moore-admin' ),
		'update_item'           => __( 'Actualizar Testimonio', 'moore-admin' ),
		'view_item'             => __( 'Ver Testimonio', 'moore-admin' ),
		'view_items'            => __( 'Ver Testimonio', 'moore-admin' ),
		'featured_image'		=> __( 'Foto de perfil', 'moore-admin' ),
		'set_featured_image'	=> __( 'Establecer Foto de perfil', 'moore-admin' ),
		'remove_featured_image'	=> __( 'Quitar Foto de perfil', 'moore-admin' ),
		'use_featured_image'	=> __( 'Usar como Foto de perfil', 'moore-admin' ),
	);
	$args = array(
		'label'                 => __( 'Testimonios', 'moore' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'page-attributes', 'post-formats' ),
		'hierarchical'          => false,
		'public'                => true,
...
// ADD NEW COLUMN
add_filter('manage_posts_columns', 'moore_columns_head', 10, 2);
// add_filter('manage_pages_columns', 'moore_columns_head', 10, 2);
add_action('manage_posts_custom_column', 'moore_columns_content', 10, 2);
add_action('manage_pages_custom_column', 'moore_columns_content', 10, 2);
function moore_columns_head($defaults, $post_type) {
...
function moore_columns_content($column_name, $post_ID) {
