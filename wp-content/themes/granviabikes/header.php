	...
	<div id="wrapper-navbar" class="fixed-top" itemscope itemtype="http://schema.org/WebSite">
		...
		<div id="topbar" class="navbar navbar-expand navbar-dark bg-dark">
			...
			if ($topbar_logo_id) {
				...
				echo '<img src="'.get_stylesheet_directory_uri().'/img/logo-trek-store-granviabikes.png" width="107" height="22">';
			} ?>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-black d-lg-none">

			<!-- Your site title as branding in the menu -->
			<?php if ( ! has_custom_logo() ) { ?>

				<a href="<?php echo get_home_url(); ?>" class="navbar-brand custom-logo-link default-logo" rel="home">
					<img src="<?php echo get_stylesheet_directory_uri() ?>/img/logo-trek-granviabikes-blanco-548x62.png" width="198" height="22" class="img-fluid" alt="<?php bloginfo('name'); ?>">
				</a> 
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-black d-none d-lg-flex">

			<!-- Your site title as branding in the menu -->
			<?php if ( ! has_custom_logo() ) { ?>

				<a href="<?php echo get_home_url(); ?>" class="navbar-brand custom-logo-link default-logo" rel="home">
					<img src="<?php echo get_stylesheet_directory_uri() ?>/img/logo-trek-granviabikes-blanco-548x62.png" width="198" height="22" class="img-fluid" alt="tiendas de bicicletas en zaragoza">
				</a> 
