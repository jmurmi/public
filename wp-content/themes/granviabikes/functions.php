...
function editor_color_palette() {
    add_theme_support( 'editor-color-palette', array(
            ...
            array(
                'name'  => __( 'Light 2 #F1DADE', 'sumun-admin' ),
                'slug'  => 'light-2',
                'color' => '#F1DADE',
            ),
            array(
                'name'  => __( 'Rojo #EB5759', 'sumun-admin' ),
                'slug'  => 'red',
                'color' => '#EB5759',
            ),
            array(
                'name'  => __( 'Rojo 2 #d9304d', 'sumun-admin' ),
                'slug'  => 'red-2',
                'color' => '#d9304d',
            ),
            array(
            ...
            array(
                'name'  => __( 'Naranja #d5a100', 'sumun-admin' ),
                'slug'  => 'orange',
                'color' => '#d5a100',
            ),
            array(
            ...
            array(
                'name'  => __( 'Rosa #e6ae9c', 'sumun-admin' ),
                'slug'  => 'pink',
                'color' => '#e6ae9c',
            ),
            array(
                'name'  => __( 'Azul #102f47', 'sumun-admin' ),
                'slug'  => 'blue',
                'color' => '#102f47',
            ),
            array(
                'name'  => __( 'Púrpura #5175b9', 'sumun-admin' ),
                'slug'  => 'purple',
                'color' => '#5175b9',
            ),
            array(
            ...
            array(
                'name'  => __( 'Gris #6da8a5', 'sumun-admin' ),
                'slug'  => 'gray',
                'color' => '#6da8a5',
            ),
            array(
                'name'  => __( 'Verde 2 #efd459', 'sumun-admin' ),
                'slug'  => 'green-2',
                'color' => '#efd459',
            ),
        )
...
add_filter( 'woocommerce_add_to_cart_fragments', 'sumun_add_to_cart_fragment' );
function sumun_add_to_cart_fragment( $fragments ) {
    global $woocommerce;
...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,300;0,500;1,300;1,500&display=swap' );

    wp_enqueue_style( 'sumun-styles', get_stylesheet_directory_uri() . '/css/child-theme.min.css', array(), $the_theme->get( 'Version' ) );
    wp_enqueue_script( 'jquery');

    // wp_enqueue_script( 'bootstrap-dropdownhover', get_stylesheet_directory_uri() . '/js/bootstrap-dropdownhover.min.js', array(), '1.1.0', true );

    wp_enqueue_script( 'vissense', get_stylesheet_directory_uri() . '/js/isInViewport.min.js', array('jquery'), $the_theme->get( 'Version' ), true );
...
function get_faqs() {
    ...
    if ($preguntas_frecuentes) {
        $index = 0;
        $r .= '<h2 class="text-center pt-5">'.__( 'Preguntas más frecuentes', 'sumun' ).'</h2>';
